        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-gray-300">
                Work directly with experienced USA-based developers, not automated systems or overseas call centers.
                Get personalized support and strategic guidance from the company founder himself.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                ...
                <div>
                  ...
                  <ul className="text-gray-300 space-y-1 text-sm">
                    ...
                    <li>• USA-based company with direct founder support</li>
                  </ul>
                </div>
              </div>
            </div>
