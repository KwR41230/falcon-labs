...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://blog.falconlabs.tech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 border border-slate-600 rounded-lg flex items-center justify-center hover:border-amber-400 hover:bg-slate-700 transition-colors">
                    <svg className="w-5 h-5 text-slate-300" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12.158 12.182c-1.335 0-2.375 1.093-2.375 2.416 0 1.336 1.04 2.416 2.375 2.416 1.323 0 2.375-1.08 2.375-2.416 0-1.323-1.052-2.416-2.375-2.416zm0 3.6c-.706 0-1.281-.563-1.281-1.259 0-.689.575-1.259 1.281-1.259.706 0 1.281.57 1.281 1.259 0 .696-.575 1.259-1.281 1.259z"/>
                      <path d="M12.158 0C5.456 0 0 5.456 0 12.158s5.456 12.158 12.158 12.158 12.158-5.456 12.158-12.158S18.86 0 12.158 0zm8.217 12.158c0 4.537-3.68 8.217-8.217 8.217V3.941c4.537 0 8.217 3.68 8.217 8.217z"/>
                    </svg>
                  </a>
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-3xl font-bold mb-4 text-amber-400">Stay Updated</h3>
          <p className="text-xl text-slate-200 mb-6">
            Check out our blog for the latest web development insights, tips, and industry trends.
          </p>
          <a
            href="https://blog.falconlabs.tech"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-gradient-to-r from-amber-400 to-orange-600 text-slate-900 px-8 py-4 rounded-lg font-semibold hover:from-amber-500 hover:to-orange-700 transition-all transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
          >
            Read Our Blog
          </a>
        </div>
